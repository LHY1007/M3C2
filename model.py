...
class Mine_init1(nn.Module):
    def __init__(self, opt, vis=False,if_end2end=False):
        super(Mine_init1, self).__init__()
        self.opt = opt
        self.vis = vis
        self.size = [1024, 512]
        self.if_end2end=if_end2end
        ...
        self.position_embeddings1 = nn.Parameter(torch.zeros(1, 2500, 512))
    ...
    def forward(self,x20,x10,dis=True):
        ...
        features_task = self.attention_init1(x20) + self.position_embeddings1  # [B, n, 512]
